...
public class TestCustomFields {
    ...
    public void testLogMessageWithCustomField(ConsoleOutput console) throws Exception {
        ...
        assertLastEventMessage(console).isEqualTo(TEST_MESSAGE);
        assertLastEventCustomFields(console).hasSize(1).anySatisfy(
                e -> assertCustomField(e).hasKey(CUSTOM_FIELD_KEY).hasValue(SOME_VALUE).hasIndex(CUSTOM_FIELD_INDEX));
    }
    ...
    public void testEscape(ConsoleOutput console) throws Exception {
        ...
        assertLastEventMessage(console).isEqualTo(messageWithKeyValue);
        assertLastEventCustomFields(console).hasSize(1).anySatisfy(
                e -> assertCustomField(e).hasKey(CUSTOM_FIELD_KEY).hasValue(HACK_ATTEMPT).hasIndex(CUSTOM_FIELD_INDEX));
    }
    ...
    public void testLogMessageWithTwoCustomFields(ConsoleOutput console) throws Exception {
        ...
        assertLastEventCustomFields(console) //
                                             .anySatisfy(e -> assertCustomField(e).hasKey(TEST_FIELD_KEY)
                                                                                  .hasValue(SOME_VALUE)
    ...
    public void testCustomFieldFromMdcWithoutRetention(ConsoleOutput console) throws Exception {
        ...
        assertLastEventCustomFields(console).anySatisfy(
                e -> assertCustomField(e).hasKey(TEST_FIELD_KEY).hasValue(SOME_VALUE).hasIndex(TEST_FIELD_INDEX));
    ...
    public void testCustomFieldFromMdcWithRetention(ConsoleOutput console) throws Exception {
        ...
        assertLastEventCustomFields(console).anySatisfy(
                e -> assertCustomField(e).hasKey(RETAINED_FIELD_KEY).hasValue(SOME_VALUE)
